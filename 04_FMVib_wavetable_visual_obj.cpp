...
public:
  ...
  Vec3f scene_min[numb_waveform], scene_max[numb_waveform], scene_center[numb_waveform];
  vector<Mesh> mMesh[numb_waveform];
  Image imageData[numb_waveform];
  ...
  void init() override
  {
    imageData[0] = Image("../obj/comet.jpg");
    imageData[1] = Image("../obj/color.jpg");
    imageData[2] = Image("../obj/color.jpg");
    imageData[3] = Image("../obj/color.jpg");
    imageData[4] = Image("../obj/obj_4.jpg");
    imageData[5] = Image("../obj/color.jpg");
    imageData[6] = Image("../obj/Cat_diffuse.jpg");
    imageData[7] = Image("../obj/11803_Airplane_body_diff.jpg");
    imageData[8] = Image("../obj/earth/Textures/Clouds_2K.png");

    // Import .obj file for the mesh
    fileName[0] = "../obj/obj_0.obj";
    fileName[1] = "../obj/obj_1.obj";
    fileName[2] = "../obj/obj_2.obj";
    fileName[3] = "../obj/obj_3.obj";
    fileName[4] = "../obj/obj_4.obj";
    fileName[5] = "../obj/obj_5.obj";
    fileName[6] = "../obj/obj_6.obj";
    ...
    for (int k = 0; k < numb_waveform; k++)
    {
      ...
      ascene->getBounds(scene_min[k], scene_max[k]);
      scene_center[k] = (scene_min[k] + scene_max[k]) / 2.f;
      // ascene->print();
      mMesh[k].resize(ascene->meshes());
  ...
  void onProcess(Graphics &g) override
  {
    ...
    // Scaling for objxxx
    float tmp = scene_max[shape][0] - scene_min[shape][0];
    tmp = std::max(scene_max[shape][1] - scene_min[shape][1], tmp);
    tmp = std::max(scene_max[shape][2] - scene_min[shape][2], tmp);
    tmp = 2.f / tmp;
    g.scale(tmp);
