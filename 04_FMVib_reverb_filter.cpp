...
public:
  ...
  void init() override
  {
    ...
    createInternalTriggerParameter("reverberation", 0.3, 0., 1);
    // 	LOW_PASS,	HIGH_PASS
    createInternalTriggerParameter("filterType", 0, 0, 1); 
...
// \param[in] numh		total number of harmonics
  ...
  void updateFromParameters()
  {
    ...
    reverb.decay(getInternalParameterValue("reverberation"));
  }
  void updateWaveform(){
